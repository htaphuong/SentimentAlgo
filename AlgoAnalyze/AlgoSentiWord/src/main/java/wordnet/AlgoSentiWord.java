...
public class AlgoSentiWord {
    ...
    public static void main(String[] args) throws Exception {
        ...
        */
        ...
        //predictAllDataSet();
        //predictExtendAllDataSet();

        //predictOneFileWithDetailResult();
        //predictOneFileWithDetailResult02(); // Test with formula 02

        predictAllDataSetWithDetailResult();
    }
    ...
    public static String predictOneFileWithDetailResult() throws Exception {
        ProcessRunner processRunner = new ProcessRunner();
        return processRunner.predictWithDetailResult();
    }

    public static String predictExtendOneFile() throws Exception {
        ProcessRunner processRunner = new ProcessRunner();
        return processRunner.predictExtend();
    }
    ...
    public static int predictWithDetail(String content) throws IOException {
        ProcessRunner processRunner = new ProcessRunner();
        return processRunner.predictWithDetail(content);
    }

    public static double predictWithScore(String content) throws IOException {
        ProcessRunner processRunner = new ProcessRunner();
        return processRunner.predictWithScore(content);
    }

    public static String predictOneFileWithDetailResult02() throws Exception {
        ProcessRunner processRunner = new ProcessRunner();
        return processRunner.predictWithDetailResult02();
    }

    public static double predictStopWord(String content) throws IOException {
        ProcessRunner processRunner = new ProcessRunner();
        return processRunner.predictStopWord(content);
    }
    ...
    public static void predictAllDataSetWithDetailResult() throws Exception {
        String original_path = PathConfigurationRoot.original;
        ...
        for (String name_test : testingFileNames){
            ...
            //String result = predictOneFile();
            String result = predictOneFileWithDetailResult();
            s += result + "\n";
    ...
    public static void predictExtendAllDataSet() throws Exception {
        String original_path = PathConfigurationRoot.original;
        ...
        for (String name_test : testingFileNames){
            ...
            String result = predictExtendOneFile();
            s += result + "\n";
